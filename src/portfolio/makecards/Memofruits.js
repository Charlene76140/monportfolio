                        ...
                        <div className="card py-3">
                            <div className="d-flex flex-column justify-content-between">
                                ...
                                <div className="card-body d-flex flex-column justify-content-between">
                                    ...
                                    <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#memo">
                                        Voir le projet <i class="fas fa-search-plus"></i>
                                    </button>
                                </div>
                            </div>
                        </div>
                        <div class="modal fade" id="memo" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body text-dark">
                                        <div className="row">
                                            ...
                                            <div className="d-flex justify-content-center"><img src={img} className="imgmodal" alt="logo memory"/></div>
                                            </div>
