...
function Professionnal () {
    ...
    return (
        <div className="colorProfessionnal container-fluid d-flex flex-column justify-content-between" >
            <section id="carrer" className="container-fluid">
                <h2 className="text-center py-4"><i class="fas fa-laptop"></i> Mon parcours professionnel</h2>
                <hr />
                <Listprofessionnal />
